...
import { UserPlus, Mail, Lock, Eye, EyeOff, TrendingUp } from 'lucide-react';
...
function RegisterSales() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      setLoading(true);
      await signup(email, password, 'sales');
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            ...
            {' atau '}
            <Link to="/register-admin" className="font-medium text-green-600 hover:text-green-500">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="appearance-none relative block w-full px-12 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 focus:z-10 sm:text-sm pr-12"
